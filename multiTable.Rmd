...
The following table contains a list of multi-data type (informatics and biomedical) platforms that can help researchers work with publicly available data and or their own data. Multi-data type platforms are those which work with a wide variety of data types, from imaging data to “omics” data, and provide computing resource support across different areas of bioinformatics research. 
