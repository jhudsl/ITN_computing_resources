...
new_imaging_CaPTk <- tibble(
  ...
  `Unique Factor` = "CaPTk beyond being a stand-alone software client it also makes its computational functionality on image analytics available for free, through the Image Processing Portal (IPP) that offers compute power through the CaPTk's supporting high performance computing cluster.",
