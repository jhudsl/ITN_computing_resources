...
The following table contains a list of informatics resources funded by ITCR grants. Resources are remotely hosted sources of curated or collaborative data that are available to researchers. These platforms catalog common human genetic sequencing data, including genomic, epigenomic, transcriptomic, and proteomic data, cancer imaging data, radiology data, along with analytic and graphical tools to facilitate research endeavours. They also provide data to specific computing platforms which have been highlighted within the various computing resource tables. Note that, all resource summaries were taken from their respective sources.
...
generalData <- read_csv(file = here::here("data/ictr_table_resources_new.csv"))
generalData
