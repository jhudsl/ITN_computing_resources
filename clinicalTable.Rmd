...
The following table contains a list of clinical informatics platforms funded by ITCR grants. Clinical platforms work with several clinical data types, such as EMR Text and Clinical Notes, utilizing Natural Language Processing techniques, AI and machine learning algorithms in order to generate actionable insights with automated research tools. Note that, all resource summaries were taken from their respective sources.
...
for (row in 1:nrow(generalData)) {
  ...
  if(status == "Yes") {
    target %<>%
    mutate(Platform = paste0(Platform,'<br></br>','<img src="ITCRLogo.png" height="30"> </img>'))
