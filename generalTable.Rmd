...
The following table contains a list of general informatics and biomedical platforms funded by ITCR grants. General platforms are those platforms which work with a wide variety of data types, from imaging data to “omics” data and provide computing resource support across different areas of bioinformatics research. Note that, all resource summaries were taken from their respective sources.
