...
generalData <- read_csv(file = here::here("data/ictr_table_imaging_new.csv")) 
#generalData
...
modified_imaging <- trimmedData %>% 
  mutate(Category = "Imaging") %>% relocate(Category, .after = Platform)
